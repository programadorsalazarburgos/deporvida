...
<div>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <h5>Resultado @{{ filtered.length}} de @{{ totalItems}} total Ejes</h5>
        </div>
    </div>
    ...
    <div id="table-action" class="row">
        <div class="col-lg-12">
            ...
            <ul id="tableactiondTab" class="nav nav-tabs">
                <li class="active">
                    <a href="#table-table-tab" data-toggle="tab">Ejes Tematicos</a>
                </li>
            </ul>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="table-responsive">
                                ...
                                <div class="portlet-body">
                                    <div class="actions">
                                        <a ng-href="/admin/postejestematicos#/admin/postejestematicos/create-edit" class="btn btn-info"><i class='fa fa-plus'></i> Nuevo</a>
                                    </div>
                                </div>
                                                ...
                                                <div class="btn-group pull-right">
                                                    <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-expanded="false">Acciones <span class="fa fa-caret-down"></span></button>
                                                        <ul class="dropdown-menu">
                                                            <li> <a ng-href="/admin/postejestematicos#/admin/postejestematicos/create-edit/@{{data.id}}"><i class="fa fa-pencil-square-o"></i>&nbsp;Editar</a> </li>
