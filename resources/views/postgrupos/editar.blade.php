                                                    ...
                                                    <div class="btn-group pull-right">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li class="editar-grupos">
                                                                <a ng-href="/grupos/editando/@{{data.id}}">
                                                                    <i class="fa fa-pencil-square-o"></i>&nbsp;Editar
                                                                </a>
                                                            </li>
                                                            <li class="ver-beneficiarios">
                                                                <a ng-href="/admin/postgrupos#/admin/postgrupos/misbeneficiarios/@{{data.id}}">
                                                                    <i class="fa fa-search-plus"></i>&nbsp;Ver mis Beneficiarios
                                                                </a>
                                                            </li>
