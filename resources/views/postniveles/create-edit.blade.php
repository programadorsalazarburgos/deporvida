                                ...
                                <fieldset>
                                    ...
                                    <div class="col-md-12">
                                        <div class="col-md-12">
                                            ...
                                            <input class="form-control" name="descripcion" ng-model="eje.descripcion" required></input>
                                            <div ng-show="form.$submitted || form.descripcion.$touched" >
                                                <span class="label label-danger" ng-show="form.descripcion.$error.required">Requerido</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="portlet-body">
                                            <div class="actions">
                                                ...
                                                <a ng-href="admin/postniveles#/admin/postniveles" class="btn btn-orange"><i class="fa fa-reply-all"></i>&nbsp;&nbsp;Atras</a>
                                            </div>
                                        </div>
                                    </div>
