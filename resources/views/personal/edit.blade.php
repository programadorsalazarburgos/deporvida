    ...
    <form id="empleado_form">
        <fieldset>
            ...
            <div class="col-md-6">
                ...
                <div class="input-group">
                    <input value="{{$numero_documento}}" type="text" id="persona_documento" onchange="change_documento()" class="only_number form-control" name="persona[documento]" >
            ...
            <div class="col-md-6">
                ...
                <input value="{{$primer_nombre}}"  type="text" title="Solo texto" id="persona_nombre_primero" class="form-control" name="persona[nombre_primero]" maxlength="60" required="true"/>
            </div>              
            <div class="col-md-6">
                <label class="control-label" for="empleado-nombres">Segundo nombre</label>
                <input value="{{$segundo_nombre}}"  type="text" title="Solo texto" id="empleado-nombres" class="form-control" name="persona[nombre_segundo]" maxlength="60" >
            </div>
            <div class="col-md-6">
                <label class="control-label" for="empleado-apellidos">Primer apellidos</label>
                <input value="{{$primer_apellido}}" type="text" title="Solo texto" id="empleado-apellidos" class="form-control" name="persona[apellido_primero]" maxlength="60" required="true">
            </div>
            <div class="col-md-6">

                <label class="control-label" for="empleado-apellidos">Segundo apellidos</label>
                <input  value="{{$segundo_apellido}}" type="text" title="Solo texto" id="empleado-apellidos" class="form-control" name="persona[apellido_segundo]" maxlength="60" >
            </div>

            <div class="col-md-6">
                <label class="control-label" for="empleado-email">Email</label>
                <input value="{{$email}}" type="email" id="persona_correo_electronico" class="form-control" name="persona[correo_electronico]" maxlength="100">
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                ...
                <input value="{{$fecha_nacimiento}}" type="text" id="persona_fecha_nacimiento" name="persona[fecha_nacimiento]" class="fecha form form-control" required="true">
            </div>
            <div class="col-md-6">
        ...
        <fieldset class="data_hide">
            ...
            <div class="col-md-6">
                ...
                <select id="persona_id_residencia_barrio" class="form-control" name="persona[id_residencia_barrio]" required="true">
                    ...
                    <option value="{{$temp->id}}">{{$temp->nombre_barrio}}</option>
                    @endforeach
                </select>
            ...
            <div class="col-md-6">
                ...
                <input class="form-control" id="persona_residencia_direccion" placeholder="Digita Dirección" name="persona[residencia_direccion]" required="true" readonly="true" value="{{$residencia_direccion}}"/>
            </div>
            <div class="col-md-6">
                <label class="control-label" for="empleado-direccion">Observaciones</label>
                <input class="form-control" id="persona_residencia_direccion_observacion" placeholder="" name="persona[residencia_direccion_observacion]" />
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                ...
                <input min="0" type="number" id="persona_telefono_fijo" class="form-control" name="persona[telefono_fijo]" maxlength="45">
            </div>
            <div class="col-md-6">
                <label class="control-label" for="empleado-celular">Celular</label>
                <input min="0" type="number" id="persona_telefono_movil" class="form-control" name="persona[telefono_movil]" maxlength="45" >
            </div>
        </fieldset>
        <fieldset class="data_hide">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <input type="text" id="ficha_profesion" class="form-control" name="ficha[profesion]" maxlength="100" required="true">
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" id="ficha_universidad" class="form-control" name="ficha[universidad]" maxlength="100" required="true">
                </div>
            </div>
        </fieldset>
        <fieldset class="data_hide">
            ...
            <div class="col-md-6">
                ...
                <input type="number" min="0" id="ficha_cuantos_hijos" class="form-control" name="ficha[cuantos_hijos]">
            </div>
            <div class="col-md-6">
            ...
            <div class="row">
                ...
                @endforeach
                <div class="col-md-3">
                    <input type="" name="grupo_poblacional[][otro]" id="grupo_poblacional_otro" placeholder="Especifique el otro" class="form form-control"/>
                </div>
            </div>
        </fieldset>
        <fieldset class="data_hide">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <label style="text-transform: uppercase">
                        <input type="checkbox" id="id_discapacidad_{{$temp->id_discapacidad}}" name="discapacidad[]" value="{{$temp->id_discapacidad}}">{{$temp->descripcion}}
                    </label>
                </div>
                @endforeach
            </div>
            ...
            <div class="col-md-6" id="div_enfermedad">
                ...
                <input type="text" id="ficha_enfermedad" class="form-control" name="ficha[enfermedad]">
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                ...
                <input type="text" id="ficha_medicamentos" class="form-control" name="ficha[medicamentos]">
            </div>
            <div class="col-md-6">
        ...
        <fieldset class="data_hide">
            ...
            <div class="col-md-6">
                <div class="form-group field-empleado-no_libreta_militar">
                    ...
                    <input type="text" id="empleado-no_libreta_militar" class="form-control" name="ficha[no_libreta_militar]">
                </div>
            </div>
            <div class="col-md-6">
                <label class="control-label" for="empleado-distrito_militar">Distrito militar</label>
                <input type="text" id="empleado-distrito_militar" class="form-control" name="ficha[distrito_militar]" >
            </div>
            <div class="col-md-6">
                <label class="control-label" for="empleado-skype">Skype</label>
                <input type="text" id="empleado-skype" class="form-control" name="ficha[skype]" maxlength="50" >
            </div>
            <div class="col-md-12">
        ...
        <fieldset class="data_hide">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <label style="text-transform: uppercase">
                        <input type="checkbox" id="id_disciplina_{{$temp->id}}" name="disciplina[]" value="{{$temp->id}}">{{$temp->descripcion}}
                    </label>
                </div>
                @endforeach
            </div>
