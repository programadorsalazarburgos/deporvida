    ...
    <div id="table-action" class="row">
        <div class="col-lg-12">
            ...
            <ul id="tableactiondTab" class="nav nav-tabs">
                <li class="active">
                    <a href="#table-table-tab" data-toggle="tab">@{{subtitle}}</a>
                </li>
            </ul>
                            ...
                            <div class="table-responsive">
                                ...
                                <div class="portlet-body">
                                    <div class="col-md-12">
                                        <div class="col-md-4">
                                            <div class="actions">
                                                <a ng-href="/admin/postcalificacionesescala#/admin/postcalificacionesescala/create-edit" class="btn btn-info"><i class='fa fa-plus'></i> Nuevo</a>
                                            </div>
                                        </div>
                                ...
                                <table id="example-export" class="table table-hover table-striped table-bordered table-advanced tablesorter" ng-init="getData(tipo)">
                                    <thead>
                                        ...
                                        <th>NUMERO&nbsp;<a ng-click="sort_by('customerName');"><i class="glyphicon glyphicon-sort"></i></a></th>
                                    ...
                                    <tbody>
                                        <tr dir-paginate="data in list|orderBy:sortKey:reverse|filter:search|itemsPerPage: pageSize">
                                            ...
                                            <td>@{{data.numero | uppercase }} </td>
                                            <td>@{{data.observaciones | uppercase }} </td>
                                            <td>
                                                <div class="btn-group pull-right">
                                                    <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-expanded="false">Acciones <span class="fa fa-caret-down"></span></button>
                                                        <ul class="dropdown-menu">
                                                            <li> <a ng-href="/admin/postcalificacionesescala#/admin/postcalificacionesescala/create-edit/@{{tipo}}/@{{data.id}}"><i class="fa fa-pencil-square-o"></i>&nbsp;Editar</a> </li>
