...
<div class="container">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="row">
                <div class="col-md-10">
                    <form class="form-horizontal" id="form_create_escenario" name="frm" novalidate>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="details">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <select name="tipoescenario" ng-model="tipoescenario" class="form-control" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input class="form-control" placeholder="Digita Nombre Escenario" name="nombre_escenario" ng-model="nombre_escenario" required></input>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <textarea class="form-control" placeholder="Digita descripción" name="descripcion" ng-model="descripcion" required></textarea>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-6">
                                            ...
                                            <button type="submit" class="btn btn-success" ng-click="formsubmit(frm.$valid)"  ng-disabled="frm.$invalid"><i class="fa fa-save"></i>&nbsp;&nbsp;Guardar Escenario</button>
