...
<style>
    ...
    #table_beneficiarios table {
        border-collapse: collapse;
    }
    #table_beneficiarios table, #table_beneficiarios th, #table_beneficiarios td {
        border: 1px solid black;
        text-align: center;
    }
    #table_beneficiarios_head th{
...
<div class="container">
    <ul id="tableactiondTab" class="nav nav-tabs">
        <li class="active"><a href="#table-table-tab" data-toggle="tab">Registro del beneficiario a la disciplina <strong>{{$nombre_grupo}}</strong></a></li>
    </ul>
    <div id="tableactionTabContent" class="tab-content">
        <form id="form_ficha" method="post">
            <fieldset>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <label class="control-label" for="id_persona_beneficiario_id_documento_tipo">*Tipo documento</label>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" title="El numero de documento es obligatorio" id="persona_documento" class="only_number form-control" name="id_persona_beneficiario[documento]" required="required">
            ...
            <fieldset>
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input value="" title="El nombre es obligatorio"  type="text" id="id_persona_beneficiario_nombre_primero" class="form-control" name="id_persona_beneficiario[nombre_primero]" maxlength="60" required="required"/>
                    </div>              
                    <div class="col-md-6">
                        <label class="control-label" for="empleado-nombres">Segundo nombre</label>
                        <input value=""  type="text" id="id_persona_beneficiario_nombre_segundo" class="form-control" name="id_persona_beneficiario[nombre_segundo]" maxlength="60" >
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <label class="control-label" for="empleado-apellidos">*Primer apellidos</label>
                        <input value="" title="El apellido es obligatorio" type="text" id="id_persona_beneficiario_apellido_primero" class="form-control" name="id_persona_beneficiario[apellido_primero]" maxlength="60" required="required">
                    </div>
                    <div class="col-md-6">

                        <label class="control-label" for="empleado-apellidos">Segundo apellidos</label>
                        <input value=""  type="text" id="id_persona_beneficiario_apellido_segundo" class="form-control" name="id_persona_beneficiario[apellido_segundo]" maxlength="60" >
                    </div>
                </div>
                <div class="row">
                <div class="col-md-6">
				...
				<div class="row">
					...
					<div class="col-md-6">
                        ...
                        <div class="input-group">
                            <input type="text" id="id_persona_beneficiario_fecha_nacimiento" name="id_persona_beneficiario[fecha_nacimiento]" class="form form-control" required="required">
            ...
            <fieldset>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <select id="ficha_id_estado_escolaridad" class="form-control" name="ficha[id_escolaridad_estado]" required="required">
                            <option value="">Seleccione</option>
            ...
            <fieldset>
                <div class="row">
                    <div class="panel">
                        <div class="panel-heading">Grupo poblacional</div>
                        <div class="panel-body">                    
						...
						<div id="panelBodyAcudiente" class="panel-body" style="display:none;">
							<div class="row">
								...
								<div class="col-md-6">
									...
									<input title="El documento del acudiente es requerido" type="text" class="form form-control" id="id_persona_acudiente_documento" name="id_persona_acudiente[documento]" style="text-align: right;" value="-1">
								</div>
							</div>
							<div class="row">
								<div class="col-md-6">
