...
<div class="form-group">
<label for="note" class="col-sm-2 control-label">Literal</label>
<div class="col-sm-8">
    <input class="form-control" placeholder="Digita Literal" name="literal" ng-model="literal" required></input>
    <span class="label label-danger" ng-show="frm.literal.$dirty && frm.literal.$error.required">Requerido</span>
</div>
</div>
...
<div ng-repeat="car in cars">
 ...
 <button type="submit" class="btn btn-success" ng-click="formsubmit(frm.$valid)"  ng-disabled="frm.$invalid"><i class="fa fa-save"></i>&nbsp;&nbsp;Guardar Sede</button>
