<script>
    function download()
    {
        $.ajax({
            ...
            {
                var headers = {FICHA_NO:"FICHA_NO",VINCULADO_ACTUALMENTE:"VINCULADO_ACTUALMENTE",FICHA_ID: "FICHA_ID",FECHA_REGISTRO:"FECHA_REGISTRO",FECHA_RETIRO:"FECHA_RETIRO",PROGRAMA:"PROGRAMA",MODALIDAD:"MODALIDAD",PUNTO_DE_ATENCION:"PUNTO_DE_ATENCION",BARRIO_PUNTO_DE_ATENCION:"BARRIO_PUNTO_DE_ATENCION",COMUNA_PUNTO_DE_ATENCION:"COMUNA_PUNTO_DE_ATENCION",COMUNA_DE_IMPACTO:"COMUNA_DE_IMPACTO",ID_MONITOR:"ID_MONITOR",MONITOR:"MONITOR",ASISTENCIAS_BENEFICIARIO:"ASISTENCIAS_BENEFICIARIO",CODIGO_GRUPO:"CODIGO_GRUPO",NIVEL_GRUPO:"NIVEL_GRUPO",GRUPO_ACTIVO:"GRUPO_ACTIVO",ID_BENEFICIARIO:"ID_BENEFICIARIO",PRIMER_NOMBRE:"PRIMER_NOMBRE",SEGUNDO_NOMBRE:"SEGUNDO_NOMBRE",PRIMER_APELLIDO:"PRIMER_APELLIDO",SEGUNDO_APELLIDO:"SEGUNDO_APELLIDO",DOCUMENTO:"DOCUMENTO",NUM_DOC:"NUM_DOC",SEXO:"SEXO",FECHA_NAC:"FECHA_NAC",EDAD:"EDAD",TELEFONO:"TELEFONO",CORREO_ELECTRONICO:"CORREO_ELECTRONICO",PAIS:"PAIS",DEPARTAMENTO:"DEPARTAMENTO",MUNICIPIO:"MUNICIPIO",DIRECCION:"DIRECCION",ESTRATO:"ESTRATO",BARRIO:"BARRIO",COMUNA_RESIDENCIA:"COMUNA_RESIDENCIA",CORREGIMIENTO:"CORREGIMIENTO",VEREDA:"VEREDA",OCUPACION:"OCUPACION",ESCOLARIDAD:"ESCOLARIDAD",ESTADO_ESCOLARIDAD:"ESTADO_ESCOLARIDAD",AUTORECONOCE:"AUTORECONOCE",DISCAPACIDAD:"DISCAPACIDAD",TIPO_DISCAPACIDAD:"TIPO_DISCAPACIDAD",INDIGENA:"INDIGENA",AFRODESCENDIENTE:"AFRODESCENDIENTE",VICTIMA_DEL_CONFLICTO:"VICTIMA_DEL_CONFLICTO",ADULTO_MAYOR:"ADULTO_MAYOR",LGBTI:"LGBTI",GRUPO_MUJERES:"GRUPO_MUJERES",GRUPO_JOVENES:"GRUPO_JOVENES",JAC:"JAC",JAL:"JAL",OTRO_CUAL:"OTRO_CUAL",PRIMER_NOMBRE_ACUDIENTE:"PRIMER_NOMBRE_ACUDIENTE",SEGUNDO_NOMBRE_ACUDIENTE:"SEGUNDO_NOMBRE_ACUDIENTE",PRIMER_APELLIDO_ACUDIENTE:"PRIMER_APELLIDO_ACUDIENTE",SEGUNDO_APELLIDO_ACUDIENTE:"SEGUNDO_APELLIDO_ACUDIENTE",DOCUMENTO_ACUDIENTE:"DOCUMENTO_ACUDIENTE",NUM_DOC_ACUDIENTE:"NUM_DOC_ACUDIENTE",SEXO_ACUDIENTE:"SEXO_ACUDIENTE",FECHA_NAC_ACUDIENTE:"FECHA_NAC_ACUDIENTE",EDAD_ACUDIENTE:"EDAD_ACUDIENTE",TELEFONO_ACUDIENTE:"TELEFONO_ACUDIENTE",CORREO_ACUDIENTE:"CORREO_ACUDIENTE",PARENTESCO:"PARENTESCO",PARENTESCO_OTRO:"PARENTESCO_OTRO"};
                exportCSVFile(headers, data, 'Reporte ficha basica');
            }
        })
    }
</script>
        ...
        <div class="col-lg-12">
            ...
            <div id="tableactionTabContent" class="tab-content">
                <div id="table-table-tab" class="tab-pane fade in active">
                    ...
                    <form name="form" class="form-vertical" role="form" method="post" enctype="multipart/form-data" action="{{url('export/excelreporteficha_corta')}}" novalidate>
                        <fieldset>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-4">
                                    <label for="user_firstname" style="color: black;">Estado grupo:</label>
                                    <select name="estado" ng-model="filtros.estado" class="form-control">
                        ...
                        <div class="row reporte">
                            <div class="col-md-12">
                                <div class="portlet-body">
                                    <div class="actions">
                                        <button type="button" onclick="download()" class="btn btn-success" style=""><i class="fa fa-file-excel-o" aria-hidden="true" ></i> Exportar Excel</button>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
