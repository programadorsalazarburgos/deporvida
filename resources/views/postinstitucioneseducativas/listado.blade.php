...
<script type="text/javascript" src="js/institucion.listar.js<?= $v; ?>"></script>
...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-lg-12">
      <div class="pagination-panel ng-binding">Resultado  de <span class="count_datatable"></span> total Eps</div>
    </div>

    <div class="col-md-12">
        <button class="btn btn-danger" id="combinar_button"><i class="glyphicon glyphicon-resize-small"></i> Combinar</button>
        <br/>
        <br/>
        <a href="institucioneseducativas/crear" class="btn btn-info" id="nuevo"><i class="glyphicon glyphicon-plus"></i> Nuevo</a>
        <br/>
        <br/>
    </div>
    <div class="col-md-12">
