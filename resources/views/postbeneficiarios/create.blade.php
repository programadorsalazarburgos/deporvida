                          ...
                          <div class='col-sm-4'>    
                            ...
                            <div class='col-sm-4'>
                              <div class='form-group'>
                                ...
                                <input type="text" class="form-control" ng-model="numero_ficha" placeholder="Ficha No" type="number" ng-blur="onBlurFicha($event)" required>
                                  <div id="repetido_ficha">
                          ...
                          <div class='row'>
                            ...
                            <div class='col-sm-6'>
                              <div class='form-group'>
                                ...
                                <input class="form-control" ng-model="no_documento_beneficiario" type="number"  required="true" size="30" type="text" placeholder="No Documento" />
                          ...
                          <div class='row'>
                            ...
                            <div class='col-sm-4'>
                              <div class='form-group'>
                                ...
                                <input type="text" class="form-control" value="edad" ng-model="edad_beneficiario" placeholder="Edad" required>
                          ...
                          <div class='row'>
                            <div class='col-sm-6'>
                              <div class='form-group'>
                                ...
                                <input class="form-control" required="true" size="30" type="text" placeholder="Telefono" type="number" ng-model="telefono_beneficiario"/>
                          ...
                          <div class='row'>
                            ...
                            <div class='col-sm-4'>
                              <div class='form-group'>
                                ...
                                <input type="text" type="number" class="form-control" ng-model="cantidad_hijos" placeholder="Cuantos Hijos?"  ng-disabled="isDisabled">
...
<p ng-repeat="grupo_poblacion in grupos_poblacionales">
      ...
      @{{grupo_poblacion.nombre}}<br/>
                  ...
                  <div class='row'>
                    ...
                    <div class='col-sm-6'>
                      <div class='form-group'>
                        <label for="user_email">No Documento</label>
                        <input class="form-control" type="number" ng-model="no_documento_pariente" size="30" type="text" / placeholder="No Documento">
                  ...
                  <div class='row'>
                    <div class='col-sm-6'>
                      <div class='form-group'>
                        <label for="user_email">Telefono</label>
                        <input type="text" class="form-control" ng-model="telefono_pariente" placeholder="Telefono Pariente" type="number" required>
