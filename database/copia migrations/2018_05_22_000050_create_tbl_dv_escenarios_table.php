...
class CreateTblDvEscenariosTable extends Migration
{
    /**
     * Schema table name to migrate
     * @var string
     */
    public $set_schema_table = 'tbl_dv_escenarios';

    /**
     * Run the migrations.
     * @table tbl_dv_escenarios
     *
     * @return void
     */
    public function up()
    {
        ...
        Schema::create($this->set_schema_table, function (Blueprint $table) {
            ...
            $table->integer('activo')->nullable()->default('1')->comment('1=activo
0=eliminado');
