...
class CreateTblGenContratoCuentaCobroTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create($this->set_schema_table, function (Blueprint $table) {
            ...
            $table->index(["id_cuenta_cobro_estado"], 'tbl_gen_contrato_cuenta_cobro_fk1');
            $table->nullableTimestamps();


            $table->foreign('id_cuenta_cobro_estado', 'tbl_gen_contrato_cuenta_cobro_fk1')
                ->references('id')->on('tbl_gen_contrato_cuenta_cobro_estado')
                ->onDelete('restrict')
                ->onUpdate('restrict');
        });
    }
