...
var SeriesApp = angular.module('SeriesApp', ['ui.bootstrap', 'ngRoute', 'ngResource', 'ngCkeditor', 'truncate', 'ngMessages', 'selector', 'ui.select', 'timepickerPop']).constant('API_URL');
...
SeriesApp.config(['$routeProvider', function ($routeProvider) {
        $routeProvider.when("/admin/postgrupos", {redirectTo: "/admin/postgrupos"});

        $routeProvider.when("/admin/postgrupos", {
            controller: "GruposCrtl",
            templateUrl: "index-grupos"
        });

        $routeProvider.when("/admin/postgrupos/create", {
            controller: "CreateGrupoCtrl",
            templateUrl: "create-grupos",

        });


        $routeProvider.when("/admin/postgrupos/editando/:id", {
            controller: "EditarGrupoCtrl",
            templateUrl: "editar-grupos"
        });


        $routeProvider.when("/admin/postgrupos/beneficiarios/:id", {
            controller: "BeneficiarioGrupoCtrl",
            templateUrl: "beneficiario-grupos"
        });

        $routeProvider.when("/admin/postgrupos/misbeneficiarios/:id", {
            controller: "MisBeneficiariosGrupoCtrl",
            templateUrl: "misbeneficiarios-grupos"
        });


        $routeProvider.when("/admin/postgrupos/editando/mibeneficiario/:id", {
            controller: "EditarMiBeneficiarioCtrl",
            templateUrl: "editar-mibeneficiario"
        });


        $routeProvider.otherwise("/admin/postgrupos");
    }]);