...
SeriesApp.config(['$routeProvider', function ($routeProvider) {
    $routeProvider.when("/admin/postcomunas", {redirectTo:"/admin/postcomunas"});

    $routeProvider.when("/admin/postcomunas", {
        controller: "ComunasCrtl",
        templateUrl: "index-comunas"
    });

    $routeProvider.when("/admin/postcomunas/create", {
        controller: "CreateComunaCtrl",
        templateUrl: "create-comunas"
    });


$routeProvider.when("/admin/postcomunas/editando/:id", {
        controller: "EditarComunaCtrl",
        templateUrl: "editar-comunas"
    });



    $routeProvider.otherwise("/admin/postcomunas");
}]);
