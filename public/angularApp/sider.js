...
var SeriesApp = angular.module('SeriesApp', ['ui.bootstrap', 'ngRoute', 'ngResource', 'ngCkeditor','truncate', 'ngMessages', 'akoenig.deckgrid']).constant('API_URL');
...
SeriesApp.config(['$routeProvider', function ($routeProvider) {
    ...
    $routeProvider.when("/", {
        controller: "SiderCrtl",
        templateUrl: "index-sider"
    });

    $routeProvider.when("/descripcion/:id", {
        controller: "DescripcionProgramaCtrl",
        templateUrl: "descripcion-programas"
    });
