...
SeriesApp.config(['$routeProvider', function ($routeProvider) {
    $routeProvider.when("/admin/postinstituciones", {redirectTo:"/admin/postinstituciones"});

    $routeProvider.when("/admin/postinstituciones", {
        controller: "InstitucionesCrtl",
        templateUrl: "index-instituciones"
    });

    $routeProvider.when("/admin/postinstituciones/create", {
        controller: "CreateInstitucionCtrl",
        templateUrl: "create-instituciones"
    });


$routeProvider.when("/admin/postinstituciones/editando/:id", {
        controller: "EditarInstitucionCtrl",
        templateUrl: "editar-instituciones"
    });


    $routeProvider.otherwise("/admin/postinstituciones");
}]);
