...
{
    $routeProvider.when("/admin/postbarrios", {redirectTo:"/admin/postbarrios"});

    $routeProvider.when("/admin/postbarrios", {
        controller: "BarriosCrtl",
        templateUrl: "index-barrios"
    });

    $routeProvider.when("/admin/postbarrios/create", {
        controller: "CreateBarrioCtrl",
        templateUrl: "create-barrios"
    });
    $routeProvider.when("/admin/postbarrios/editando/:id", 
    {
      controller: "EditarBarrioCtrl",
      templateUrl: "editar-barrios"
    });
    $routeProvider.otherwise("/admin/postbarrios");
}]);
