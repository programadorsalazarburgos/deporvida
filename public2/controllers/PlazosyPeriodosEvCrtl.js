SeriesApp.controller('PlazosyPeriodosEvCrtl', function ($scope, $routeParams, $location, $http, $timeout, base_api, $q) {
    ...
    $scope.getData = function(tipo){
        $http.get(base_api + "/admin/postplazosyperiodosev/get/"+tipo).then(function(res) {
            $scope.list = res.data;
    ...
    $scope.eliminar = function(id) {
        ...
        function (isConfirm) {
            if (isConfirm) {
                ...
                $http.delete(base_api + '/admin/postplazosyperiodosev/delete/' + id).then(function(res) {
                    console.log(res);
