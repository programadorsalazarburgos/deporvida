...
SeriesApp.config(['$routeProvider', function ($routeProvider) {
    $routeProvider.when("/admin/postreporteficha", {redirectTo:"/admin/postreporteficha"});

    $routeProvider.when("/admin/postreporteficha", {
        controller: "ReporteFichaCrtl",
        templateUrl: "index-reporte-ficha-basica"
    });

    $routeProvider.otherwise("/admin/postreporteficha");
}]);
