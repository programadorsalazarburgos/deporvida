...
SeriesApp.config(['$routeProvider', function ($routeProvider) {
    $routeProvider.when("/admin/postzonas", {redirectTo:"/admin/postzonas"});

    $routeProvider.when("/admin/postzonas", {
        controller: "ZonasCrtl",
        templateUrl: "index-zonas"
    });

    $routeProvider.when("/admin/postzonas/create", {
        controller: "CreateZonaCtrl",
        templateUrl: "create-zonas"
    });


$routeProvider.when("/admin/postzonas/editando/:id", {
        controller: "EditarZonaCtrl",
        templateUrl: "editar-zonas"
    });



    $routeProvider.otherwise("/admin/postzonas");
}]);
