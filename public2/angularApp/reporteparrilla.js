...
SeriesApp.config(['$routeProvider', function ($routeProvider) {
    $routeProvider.when("/admin/postreporteparrilla", {redirectTo:"/admin/postreporteparrilla"});

    $routeProvider.when("/admin/postreporteparrilla", {
        controller: "ReporteParrillaCrtl",
        templateUrl: "index-reporte-parrilla"
    });

    $routeProvider.otherwise("/admin/postreporteparrilla");
}]);
