...
SeriesApp.directive("chosen", [function() 
{        
    return {
        restrict: 'A',
...
SeriesApp.directive('checkList', function() {
  return {
    scope: {
      list: '=checkList',
      value: '@'
...
SeriesApp.config(['$routeProvider', function ($routeProvider) {
    $routeProvider.when("/admin/postbeneficiarios", {redirectTo:"/admin/postbeneficiarios"});
    $routeProvider.when("/admin/postbeneficiarios", 
    {
        controller: "BeneficiariosCrtl",
        templateUrl: "index-beneficiarios"
    });
    $routeProvider.when("/admin/postbeneficiarios/create", 
    {
        controller: "CreateBeneficiarioCtrl",
        templateUrl: "create-beneficiarios",

    });

$routeProvider.when("/admin/postbeneficiarios/editando/:id", {
        controller: "EditarBeneficiarioCtrl",
        templateUrl: "editar-beneficiarios"
    });




    $routeProvider.otherwise("/admin/postbeneficiarios");
}]);
