...
var SeriesApp = angular.module('SeriesApp', ['ui.bootstrap', 'ngRoute', 'ngResource', 'ngCkeditor','truncate', 'ngMessages', 'angularUtils.directives.dirPagination']).constant('API_URL');
...
SeriesApp.config(['$routeProvider', function ($routeProvider) {
    $routeProvider.when("/admin/posteps", {redirectTo:"/admin/posteps"});

    $routeProvider.when("/admin/posteps", {
        controller: "EpsCrtl",
        templateUrl: "index-eps"
    });

    $routeProvider.when("/admin/posteps/create", {
        controller: "CreateEpsCtrl",
        templateUrl: "create-eps"
    });


$routeProvider.when("/admin/posteps/editando/:id", {
        controller: "EditarEpsCtrl",
        templateUrl: "editar-eps"
    });



    $routeProvider.otherwise("/admin/posteps");
}]);